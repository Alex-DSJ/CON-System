...
<ul class="navbar-nav" id="my-nav">
    ...
    <li class="nav-item d-none d-sm-inline-block"><a href="" class="nav-link">Building</a></li>
...
<ul class="navbar-nav ml-auto">
    <li class="nav-item">
        <a class="nav-link" data-toggle="dropdown" href="#">
            <button class="btn" class="logout" onclick="">Log Out <i class="fas fa-sign-out-alt"></i></button>
