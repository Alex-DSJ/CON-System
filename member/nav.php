...
<nav class="main-header navbar navbar-expand navbar-white navbar-light" style="margin-left:0px;!important;">
        <ul class="navbar-nav" id="my-nav">
            ...
            <li class="nav-item d-none d-sm-inline-block"><a href="" class="nav-link">Social</a></li>
            <li class="nav-item d-none d-sm-inline-block"><a href="posting.php" class="nav-link">My Posting</a></li>
            <li class="nav-item d-none d-sm-inline-block"><a href="" class="nav-link">Message</a></li>
            <li class="nav-item d-none d-sm-inline-block"><a href="" class="nav-link">Base Info</a></li>
        </ul>
